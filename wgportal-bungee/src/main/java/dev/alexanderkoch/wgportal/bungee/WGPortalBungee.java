 ...
 */
public final class WGPortalBungee extends Plugin implements Listener, PluginMessageListener {
     ...
     * Stores it for later forwarding when the player switches servers.
     */
    @Override
